...
namespace RestApi
{
    ...
    public class Rest
    {
        ...
        {
            int result = -1;
            string requestString = sApiServer + "v1/accounts/" + account + "/transactions?maxCount=1";
            string responseString = MakeRequest(requestString);
        ...
        {
            string requestString = sApiServer + "v1/accounts/" + account + "/transactions?minId=" + minTransId;
        ...
        {   // eg. https://oanda-cs-dev:1342/accounts/123456
            string requestString = sApiServer + "v1/accounts/" + account;
        ...
        {
            string requestString = sApiServer + "v1/accounts/" + account + "/positions";
        ...
        {
            string requestString = sApiServer + "v1/" + "candles?" + "accountId="+ accountid +"&instrument=" + curPair + "&granularity=H1&candleFormat=midpoint";
        ...
        {
            string requestString = sApiServer + "v1/instruments?accountId=" + account;
        ...
        {
            var requestBuilder = new StringBuilder(sApiServer + "v1/prices?instruments=");

            foreach ( var instrument in instruments )
            {
                requestBuilder.Append(instrument.InstrumentType + ",");
            }
